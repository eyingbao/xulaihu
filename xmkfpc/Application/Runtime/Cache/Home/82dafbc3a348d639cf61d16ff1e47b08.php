          ...
          <div class="col-md-12">
            <section class="panel">
              <div class="panel-heading no-b" style="padding:10px 21px; float:left;">
                ...
                <span><?php echo ($gmcc["id"]); ?></span> </div>
              <div class="panel-heading no-b" style="float:right; margin-top:15px;">
                <?php
 ?>
                <select id="accountSel" onChange="ads.selects('/Home/Mcc/monthCost?mcc='+this.value+'&date='+$('#date').val())">
              ...
              <div class="panel-body">
                <canvas id="canvas_time"  height="50"   style="margin-top:0px;"></canvas>
                <script type="text/javascript">
											var date = <?php echo ($dates); ?> ;
											ads.dates = new Array();
											for(var i = 0;i<date.length;i++){
												//ads.dates.push(date[i].replace(/2015-/,''));
												ads.dates.push(date[i]);	
											}
											//ads.cc1 = '<?php echo ($cc2); ?>';
										</script> 
              </div>
              <div class="panel-body">
                <table class="table table-bordered table-striped no-m" style="display:none;">
                  <thead>
                    <tr>
                  ...
                  <tbody id="tbd">
                    <!--<tr onclick="ads.changerTr(this)">
                      <td style="text-align:center">#1</td>
                      <td>130524荣成中磊石材</td>
                      <td style="text-align:center">206-175-1102</td>
...
<script type="text/javascript">
	...
	ads.getMonthCost(ads.children);
	//$('#date').children('option:eq(4)').get(0).selected = true;
