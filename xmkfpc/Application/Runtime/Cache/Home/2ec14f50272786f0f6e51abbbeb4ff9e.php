                                ...
                                <section class="panel">
                                   ...
                                   <table border="0" width="100%" cellpadding="0"  cellspacing="0" style="border-collapse:collapse;">
                                    ...
                                    <div class="panel-heading no-b" style="float:; margin-top:15px;">
                                        <select id="accountSel" onChange="ads.selects('/Home/Mcc/tools?mcc='+this.value+'&date='+$('#date').val())">
                                    ...
                                    <div class="panel-body">
                                   		<table class="table table-bordered table-striped no-m" id="tools">
                                            <thead>
                                                <tr>
                                                	<th style="text-align:center">编号</th>
                                                   	<th>普通账户</th>
                                                    <th style="text-align:center">CID</th>
                                                    <!--<th style="text-align:center">GA ID</th>-->
                                                    <th style="text-align:center">GA</th>
                                                    
                                                    <!--<th style="text-align:center">转化页面</th>-->
                                                    <th style="text-align:center">转化</th>
                                                    <th style="text-align:center">转化次数</th>
                                                   <th style="text-align:center">CPA（平均）</th>
                                                </tr>
                                            </thead>
                                            <tbody>
