                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-heading no-b" style="padding:10px 21px; float:;">
                                       <table id="tb" class="table table-bordered table-striped no-m" width="100%"  >
                                       		<thead>
                                                <tr height="35">
                                                	<th style="text-align:center">广告组（异常）总量</th>
                                                   	<th style="text-align:center">广告组（全部）总量</th>
                                                    <th style="text-align:center">异常总量 / 全部总量</th>
                                                </tr>
                                    ...
                                    <div class="panel-heading no-b" style="float:; margin-top:15px;">
                                        <select id="accountSel" onChange="ads.selects('/Home/AdGroup/index?mcc='+this.value+'&date='+$('#date').val())">
                                   		...
                                   		<table class="table table-bordered table-striped no-m">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">展示次数（>500）</th>
                                                    <th style="text-align:center">CTR</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbd"></tbody>
