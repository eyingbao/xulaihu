                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-heading no-b" style="float:right; margin-top:15px;">
                                        <select id="accountSel" onChange="ads.selects('/Home/AdGroup/adCountErr?mcc='+this.value+'&date='+$('#date').val())">
                                    ...
                                    <div class="panel-body">
                                   		<table class="table table-bordered table-striped no-m" id="adCountErr">
                                            <thead>
                                                <tr>
