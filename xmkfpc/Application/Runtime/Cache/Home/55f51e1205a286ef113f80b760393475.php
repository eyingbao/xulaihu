...
<!-- /top header -->
 ...
 ?>
                                        ...
                                        <select id="accountSel" onChange="ads.selects('/Home/Campaign/cpaContrast?mcc='+this.value+'&date='+$('#date').val()+'&disabled=1')">
                                    ...
                                    <div class="panel-body">
                                   		<table class="table table-bordered table-striped no-m" id="cpaContrast">
                                            <thead>
                                                <tr>
                                                	<th style="text-align:center">编号</th>
                                                   	<th>普通账户</th>
                                                    <th style="text-align:center">CID</th>
                                                    <th style="text-align:center">上7天（CPA）</th>
                                              		<th style="text-align:center">上上7天（CPA）</th>
                                                    <th style="text-align:center" class="blsa bls1" onclick="ads.cpaContrastSorts(this)">对比</th>
