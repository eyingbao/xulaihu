...
<!-- /top header -->
 ...
 ?>
                                        ...
                                        <select id="accountSel" onChange="ads.selects('/Home/Campaign/costErr?mcc='+this.value+'&date='+$('#date').val()+'&disabled=1')">
                                    ...
                                    <div class="panel-body">
                                   		<table class="table table-bordered table-striped no-m" id="campaignCostErrContrast">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">ID</th>
                                                     <!--<th >广告系列</th>
                                                   <th style="text-align:center">状态</th>-->
                                                    <th style="text-align:center">（前日）花费</th>
                                                    <th style="text-align:center">（昨日）花费</th>
                                                    <th style="text-align:center" class="blsa bls1" onclick="ads.campaignCostErrContrastSorts(this)">差值</th>
                                                    <!--<th style="text-align:center">差值比（>30%）</th>-->
...
<script type="text/javascript">
	...
	ads.campaignCostErr(ads.children);
