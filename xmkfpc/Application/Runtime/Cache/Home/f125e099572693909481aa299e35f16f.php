	...
	<div class="modal-dialog" role="document" data-width="400px"  style="width:650px;">
		<div class="modal-content">
            ...
            <ul id="myTab" class="nav nav-tabs" style="display:none">
               <li class="active"  style="width:19.9%; text-align:center;"><a href="#account_tab"  data-toggle="tab">账户端</a></li>
               <li style="width:19.9%; text-align:center;"><a href="#campaign_tab" data-toggle="tab">广告系列</a></li>
               <li style="width:17.9%; text-align:center;"><a href="#adgroup_tab" data-toggle="tab">广告组</a></li>
               <li style="width:19.9%; text-align:center;"><a href="#ga_tab" data-toggle="tab">GA网站数据</a></li>
...
<!-- /top header -->
<section class="layout"><!-- sidebar menu -->
            ...
            <section class="panel">
              <div class="panel-body">
              	...
              	<!--<div>
                    ...
                    备注：<b>昨日</b> <span><?php echo ($d1); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <b>前日</b> <span><?php echo ($d2); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <b>上周</b> <span><?php echo ($d3); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                
                </div>
                <br />-->
                
                <table class="table table-bordered table-striped" style="margin-bottom:20px; border:1px solid #000; font-weight:bold;">
                	<thead>
                    <!--<tr>
                    	<th style="text-align: left;" colspan="6">时间进度</th>
                    </tr>-->
                    
                    <tr align="center">
                    	<td width="13%" style="border-color:#000;">季度时间进度</td>
                        <td width="13%" id="schedule1" style="border-color:#000;"></td>
                        <td width="13%" style="border-color:#000;">季度消耗进度</td>
                        <td width="13%" id="schedule2" style="border-color:#000;"></td>
                         <td width="13%" style="border-color:#000;">预计完成比率</td>
                        <td width="13%" style="border-color:#000;">95.00%</td>
                ...
                <table class="table table-bordered table-striped no-m"  style="border:1px #000 solid;font-weight:bold;" id="tools">
                  <thead>
                    <tr>
                      <td style="text-align:left;border-color:#000;">部门</td>
                      <td style="text-align:center;border-color:#000;">CID</td>
                      <td style="text-align:center;border-color:#000;">实际完成</td>
                      <td style="text-align:center;border-color:#000;" id="olsa_d1"><?php echo ($d1); ?></td>
                      <td style="text-align:center;border-color:#000;" id="olsa_d2"><?php echo ($d2); ?></td>
                      <td style="text-align:center;border-color:#000;">环比涨幅</td>
                      <td style="text-align:center;border-color:#000;" id="olsa_d3"><?php echo ($d3); ?></td>
                      <td style="text-align:center;border-color:#000;">同比涨幅</td>
                    </tr>
                  </thead>
                  <tbody id="olsa">
                  </tbody>
