                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-heading no-b" style="float:right; margin-top:15px;">
                                        <select id="accountSel" onChange="ads.selects('/Home/Mcc/deliveryChannel?mcc='+this.value+'&date='+$('#date').val())">
                                    ...
                                    <div class="panel-body">
                                   		<table class="table table-bordered table-striped no-m" id="deliveryChannel">
                                            <thead>
                                                <tr>
                                                	<th style="text-align:center">编号</th>
                                                   	<th>普通账户</th>
                                                    <th style="text-align:center">ID</th>
                                                    <th style="text-align:center">PC搜索花费</th>
                                                    <th style="text-align: center">PC展示花费</th>
                                                   <th style="text-align:center">PC再营销花费</th>
                                                    <!--<th style="text-align: center">PC再营销</th>-->
                                                    
                                                    <th  style="text-align:center">移动搜索花费</th>
                                                    <th style="text-align:center">移动展示花费</th>
...
<script type="text/javascript">
	...
	ads.deliveryChannel(ads.children);
</script>
