<?php
	...
	mysqli_query($con['115'],"SET NAMES GB2312");
	$result = mysqli_query($con['115'],"SELECT DISTINCT account_id , name FROM ads_mcc WHERE (canManageClients  = 0 AND status = 1)");
